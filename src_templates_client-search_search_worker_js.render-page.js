...
/* harmony export */   "getInitSearchEngineAction": () => (/* binding */ getInitSearchEngineAction),
/* harmony export */   "getSearchAction": () => (/* binding */ getSearchAction)
/* harmony export */ });
...
let searchEngine=null;function initSearchEngine(data){searchEngine=(0,_utils_js_search__WEBPACK_IMPORTED_MODULE_0__.initSearch)('path',['path','rawBody'],data);}self.addEventListener('message',e=>{switch(e.data.type){case _templates_client_search_search_worker_actions__WEBPACK_IMPORTED_MODULE_1__.MESSAGE_TYPE.INIT:initSearchEngine(e.data.payload);break;case _templates_client_search_search_worker_actions__WEBPACK_IMPORTED_MODULE_1__.MESSAGE_TYPE.SEARCH:self.postMessage(searchEngine.search(e.data.payload));break;default:console.log('do nothing...');}});
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_js-search_dist_esm_js-search_js-node_modules_lodash_flatten_js"], () => (__webpack_require__("./src/templates/client-search/search.worker.js")))
...
/******/ 		var installedChunks = {
/******/ 			"src_templates_client-search_search_worker_js": 1
/******/ 		};
/******/ 		
...
/******/ 		__webpack_require__.x = () => {
/******/ 			__webpack_require__.e("vendors-node_modules_js-search_dist_esm_js-search_js-node_modules_lodash_flatten_js");
/******/ 			return next();
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=src_templates_client-search_search_worker_js.render-page.js.map